...
<!-- canal-teams-section -->
<section class="diagonal-section container canal-teams-con mb-5">
    <div class="diagonal-bg"></div>
    <div class="red-line"></div>
    
    <div class="content-section bg-img-none">
        <div class="container">
            <div class="img-placeholder"></div>
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <h2 class="network-heading">Canal teams</h2>
                    <img src="./assets/images/Org_Overall_Staff.png" class="img-full-screen" width="100%" height="100%" alt="Canal staff">
